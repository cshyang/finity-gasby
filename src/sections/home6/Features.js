            ...
            <div className="col-xl-6 col-lg-7 col-md-8">
              ...
              >
                <h2 className="font-size-11">
                  We want to find you the best job.
                </h2>
              </div>
            </div>
          </div>
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-6 col-md-6 col-xs-6">
                    ...
                    >
                      ...
                      <div className="mt-12 pr-lg-10 pr-md-0 pr-xs-8">
                        <h4 className="font-size-7 mb-5">Automoted Process</h4>
                        <p className="font-size-5 mb-0">
                          We search our whole database and find you the best fit.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      <div className="mt-12 pr-lg-10 pr-md-0 pr-xs-8">
                        <h4 className="font-size-7 mb-5">
                          Guaranteed Jon Interview
                        </h4>
                        <p className="font-size-5 mb-0">
                          Immediately receive a list of potential jobs.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 col-md-6 col-xs-6">
                    ...
                    >
                      ...
                      <div className="mt-12 pr-lg-10 pr-md-0 pr-xs-8">
                        <h4 className="font-size-7 mb-5">Jobs Matched Your Personality</h4>
                        <p className="font-size-5 mb-0">
                          Our algorithm match you with the jobs that fit your ambitions, dream, and unique strength.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 col-md-6 col-xs-6">
                    ...
                    >
                      ...
                      <div className="mt-12 pr-lg-10 pr-md-0 pr-xs-8">
                        <h4 className="font-size-7 mb-5">No More Blank Rejects</h4>
                        <p className="font-size-5 mb-0">
                          All companies required to stae a reason of job rejection.
                        </p>
                      </div>
                    </div>
                  </div>
